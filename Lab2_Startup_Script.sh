...
<head>
    ...
    <title>Dante Dorsey | EC2 Static Site</title>
    <style>
        /* ===== GLOBAL STYLES ===== */
        * {
            margin: 0;
...
<body>
    <div class="overlay">
        <div class="container">
            ...
            <header>
                <h1>Dante Dorsey</h1>
                <p>Author | Artist | Intellectual</p>
            </header>

            <!-- SECTION 1: ABOUT ME -->
            <section class="section">
                <h2>About Me</h2>
                <p>I am pursuing a career in cloud engineering. This is my future. Thanks to the CPG Avengers, the sky is the limit!</p>
            </section>
            ...
            <div class="image-container">
                ...
                <p>Sitting on top of the world</p>
            </div>
            ...
            <section class="section">
                <h2>Contact</h2>
                <p>Email: 17thevision@gmail.com | AWS Cloud Lab2 2026</p>
            </section>
