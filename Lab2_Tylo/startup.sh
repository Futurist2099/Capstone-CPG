...
<head>
    ...
    <title>Tylo Hamilton | EC2 Static Site</title>
    <style>
        /* ===== GLOBAL STYLES ===== */
        * {
            margin: 0;
        ...
        body {
            ...
            line-height: 1.8;
            color: #f0f0f0;
            background-image: url('https://images.unsplash.com/photo-1762291834384-09118dda091d?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D');
...
<body>
    <div class="overlay">
        <div class="container">
            ...
            <header>
                <h1>Tylo Hamilton</h1>
                <p>Collecter | Creative | Humble</p>
            </header>

            <!-- SECTION 1: ABOUT ME -->
            <section class="section">
                <h2>About Me</h2>
                <p>Family Man, ready to play in the clouds!!!</p>
            </section>

            <!-- EMBEDDED IMAGE -->
            <div class="image-container">
            <img src="https://i.giphy.com/lkxptqdgaD1V32HCMl.webp">
            ...
            <section class="section">
                ...
                <p>I built an EC2 instance that automatically installs a web server and creates a webpage by itself when it starts up, without me having to log in and set anything up manually.</p>
            </section>

            <!-- SECTION 3: CONTACT -->
            <section class="section">
                <h2>Contact</h2>
                <p>Email: firstofmyname5701@gmail.com | Facebook: Rip Bro</p>
            </section>
